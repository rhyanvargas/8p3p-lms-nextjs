...
const communityPosts = [
  {
    ...
    content: "I found the practice session really helpful today. The breakout rooms were a great way to practice the protocol with peers.",
    likes: 8,
    comments: 2,
    timeAgo: "3 hours ago"
  },
  {
    ...
    content: "Has anyone found good resources for explaining EMDR to clients? I'd appreciate any recommendations!",
    likes: 15,
    comments: 7,
    timeAgo: "1 day ago"
  }
